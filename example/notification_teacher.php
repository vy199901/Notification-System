      ...
      <div class="wrapper">
               ...
               <div class="container animatedParent animateOnce">
                  <div class="row animated bounceInUp slowest">
                     ...
                     <div class="col-md-12  my-card">
                        <span class="float-Left"><a class="mybutton mobile-block" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" onmousedown="beep3.play()"><i class="fas fa-eye"></i> View Notification</a></span>

                        <span class="float-right"><a href="" class="mybutton mobile-block" data-toggle="modal" data-target="#add_notification" onmousedown="beep3.play()"><i class="fas fa-plus"></i> Send Notification</a></span>
                     </div>
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto text-center  mb-3">
                        ...
                        <div class="collapse" id="collapseExample">
                           <div class="card card-body">
                              <?php
                        $q = "SELECT `notification`.`category`,`notification`.`message` , `notification_log`.`read_status` from `notification_log` join `notification` on `notification_log`.`notification_id` = `notification`.`notification_id` where `notification_log`.`receiver_id` = '$user_id' ";

                        $result = mysqli_query($con, $q);
                        while($row = mysqli_fetch_array($result)){
                         ?>
                              <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12 card-custom mt-5">
                                 <div class="card text-left" style="padding: 3%;">
         ...
         <div class="modal fade" id="update_notification" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
               <div class="modal-content">
                  ...
                  <form action="notification_back.php" method="post" enctype="multipart/form-data">
         ...
         <div class="modal fade" id="add_notification" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel" class="" style="color: #722942;"><b>Send Notification</b></h5>
                     <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                     </button>
                  </div>
                  ...
                  <form action="notification_back.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mx-auto mb-3 text-left text-theme">
                           ...
                           <div id="senddiv" style='display:none'>
                              <select id="add_send_category" class="form-control" name="add_send_category[]" multiple required>
                                 ...
                                 <?php
                                      $q = "SELECT `id`,`name` FROM `register` WHERE `class`='$class' ";
                     ...
                     <input type="hidden" name="creators_id" value="<?php echo $user_id;?>" >
                     <input type="hidden" name="class_id" value="<?php echo $class;?>">
                     <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                        <button type="submit" name="add_notification_teacher" class="btn btn-primary" style="background-color: #ab47bc;">Send Notification</button>
                     </div>
