            ...
            <div class="subjectcontainer">
               <div class="container animatedParent animateOnce">
                  <div class="row animated bounceInUp slowest">
                     ...
                     <?php
                        $q = "SELECT `notification`.`category`,`notification`.`message` , `notification_log`.`read_status` from `notification_log` join `notification` on `notification_log`.`notification_id` = `notification`.`notification_id` where `notification_log`.`receiver_id` = '$stud_id' ";
//                    .
